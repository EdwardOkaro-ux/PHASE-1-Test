...
db.tenants.insertOne({
  id: db.users.findOne({id: userId}).tenant_id,
...
curl -X POST "https://your-app.com/api/clients" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"name": "Test Client", "phone": "+27123456789"}'
```
...
db.tenants.find().limit(2).pretty();
"
...
db.tenants.deleteMany({subdomain: /testcompany/});
"
```
