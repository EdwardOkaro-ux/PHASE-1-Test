...
const parcelStatusConfig = {
  warehouse: { bg: 'bg-gray-100', text: 'text-gray-700', label: 'Warehouse' },
  staged: { bg: 'bg-[#E8DC88]', text: 'text-[#3C3F42]', label: 'Staged' },
                  ...
                  {documents.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={6} className="text-center py-8 text-gray-500">
                        ...
                        <Button variant="link" onClick={() => setUploadDocOpen(true)}>
                    ...
                    documents.map(doc => (
                      <TableRow key={doc.id}>
                        ...
                        <TableCell>
                          {doc.uploaded_at ? format(new Date(doc.uploaded_at), 'MMM d, yyyy h:mm a') : '-'}
                        </TableCell>
                        <TableCell>
                          <div className="flex items-center gap-1">
