          ...
          <CardContent className="py-4 px-4">
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
              <div className="flex-1 min-w-[280px]">
                <Label className="text-sm font-medium mb-2 block text-purple-800">
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
                      ...
                      <TableHead className="w-[60px] text-center">Verified</TableHead>
                    ...
                    {displayedParcels.map((parcel) => (
                      ...
                      >
                        ...
                        <TableCell className="text-center">
                          <Checkbox
                            checked={parcel.verified || false}
                            onCheckedChange={(checked) => handleVerifyParcel(parcel.id, checked)}
                            data-testid={`verify-checkbox-${parcel.id}`}
                            className={parcel.verified ? 'border-green-500 data-[state=checked]:bg-green-500' : ''}
                          />
                        </TableCell>
                        <TableCell>
                          <DropdownMenu>
